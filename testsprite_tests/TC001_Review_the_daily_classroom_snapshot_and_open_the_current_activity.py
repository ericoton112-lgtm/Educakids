...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click Entrar to sign in so the dashboard can be inspected.
        ...
        # -> Click the 'Iniciar' button (element [410]) to open the current day activity (Modo Aula) and then verify the activity view loads.
        # button "Iniciar"
